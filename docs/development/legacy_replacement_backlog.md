...
- `LRB-095` `/admin/cloud-orchestrator/campaigns`: `P0` / `phase_3_readonly` / `readonly` / owner `aicrm_next.cloud_orchestrator`
- `LRB-096` `/api/admin/cloud-orchestrator/campaigns*`: `P3` / `phase_6_timer_automation` / `timer_or_automation_execution` / owner `aicrm_next.cloud_orchestrator`
- `LRB-097` `/api/admin/cloud-orchestrator/media/upload`: `P2` / `phase_5_external_adapter` / `external_side_effect` / owner `aicrm_next.cloud_orchestrator`
- `LRB-098` `/api/admin/automation-conversion/programs*`: `P2` / `keep_guarded_until_adapter_ready` / `blocked_or_guarded` / owner `aicrm_next.automation_engine`
- `LRB-099` `/api/admin/automation-conversion/profile-segment-templates*`: `P2` / `keep_guarded_until_adapter_ready` / `blocked_or_guarded` / owner `aicrm_next.automation_engine`
- `LRB-100` `/api/admin/automation-conversion/agents*`: `P1` / `phase_4_internal_write` / `readonly` / owner `aicrm_next.automation_engine`
- `LRB-101` `/api/admin/automation-conversion/agent-outputs*`: `P2` / `keep_guarded_until_adapter_ready` / `blocked_or_guarded` / owner `aicrm_next.automation_engine`
- `LRB-102` `/api/admin/automation-conversion/agent-runs*`: `P2` / `keep_guarded_until_adapter_ready` / `blocked_or_guarded` / owner `aicrm_next.automation_engine`
- `LRB-103` `/api/admin/automation-conversion/agent-replay`: `P2` / `keep_guarded_until_adapter_ready` / `blocked_or_guarded` / owner `aicrm_next.automation_engine`
- `LRB-104` `/api/admin/automation-conversion/agent-orchestration*`: `P2` / `keep_guarded_until_adapter_ready` / `blocked_or_guarded` / owner `aicrm_next.automation_engine`
- `LRB-105` `/api/admin/automation-conversion/action-templates*`: `P2` / `keep_guarded_until_adapter_ready` / `blocked_or_guarded` / owner `aicrm_next.automation_engine`
- `LRB-106` `/api/admin/automation-conversion/task-groups*`: `P1` / `phase_4_internal_write` / `readonly` / owner `aicrm_next.automation_engine`
- `LRB-107` `/api/admin/automation-conversion/tasks/run-due`: `P3` / `phase_6_timer_automation` / `timer_or_automation_execution` / owner `aicrm_next.automation_engine`
- `LRB-108` `/api/admin/automation-conversion/tasks*`: `P2` / `keep_guarded_until_adapter_ready` / `blocked_or_guarded` / owner `aicrm_next.automation_engine`
- `LRB-109` `/api/admin/automation-conversion/workflows*`: `P2` / `keep_guarded_until_adapter_ready` / `blocked_or_guarded` / owner `aicrm_next.automation_engine`
- `LRB-110` `/api/admin/automation-conversion/workflow-nodes*`: `P3` / `phase_6_timer_automation` / `timer_or_automation_execution` / owner `aicrm_next.automation_engine`
- `LRB-111` `/api/admin/automation-conversion/dashboard`: `P2` / `keep_guarded_until_adapter_ready` / `blocked_or_guarded` / owner `aicrm_next.automation_engine`
- `LRB-112` `/api/admin/automation-conversion/executions*`: `P2` / `keep_guarded_until_adapter_ready` / `blocked_or_guarded` / owner `aicrm_next.automation_engine`
- `LRB-113` `/api/admin/automation-conversion/execution-items/{execution_item_id}/send-via-bazhuayu`: `P2` / `phase_5_external_adapter` / `external_side_effect` / owner `aicrm_next.automation_engine`
- `LRB-114` `/api/admin/automation-conversion/execution-items*`: `P2` / `keep_guarded_until_adapter_ready` / `blocked_or_guarded` / owner `aicrm_next.automation_engine`
- `LRB-115` `/api/admin/automation-conversion/member`: `P0` / `phase_3_readonly` / `readonly` / owner `aicrm_next.automation_engine`
- `LRB-116` `/api/admin/automation-conversion/member/put-in-pool`: `P2` / `keep_guarded_until_adapter_ready` / `blocked_or_guarded` / owner `aicrm_next.automation_engine`
- `LRB-117` `/api/admin/automation-conversion/member/remove-from-pool`: `P2` / `keep_guarded_until_adapter_ready` / `blocked_or_guarded` / owner `aicrm_next.automation_engine`
- `LRB-118` `/api/admin/automation-conversion/member/set-focus`: `P2` / `keep_guarded_until_adapter_ready` / `blocked_or_guarded` / owner `aicrm_next.automation_engine`
- `LRB-119` `/api/admin/automation-conversion/member/set-normal`: `P2` / `keep_guarded_until_adapter_ready` / `blocked_or_guarded` / owner `aicrm_next.automation_engine`
- `LRB-120` `/api/admin/automation-conversion/member/mark-won`: `P2` / `keep_guarded_until_adapter_ready` / `blocked_or_guarded` / owner `aicrm_next.automation_engine`
- `LRB-121` `/api/admin/automation-conversion/member/unmark-won`: `P2` / `keep_guarded_until_adapter_ready` / `blocked_or_guarded` / owner `aicrm_next.automation_engine`
- `LRB-122` `/api/admin/automation-conversion/member/push-openclaw`: `P2` / `phase_5_external_adapter` / `external_side_effect` / owner `aicrm_next.automation_engine`
- `LRB-123` `/api/admin/automation-conversion/overview`: `P0` / `phase_3_readonly` / `readonly` / owner `aicrm_next.automation_engine`
- `LRB-124` `/api/admin/automation-conversion/pools`: `P0` / `phase_3_readonly` / `readonly` / owner `aicrm_next.automation_engine`
- `LRB-125` `/api/admin/automation-conversion*`: `P1` / `phase_4_internal_write` / `internal_write` / owner `aicrm_next.automation_engine`
- `LRB-126` `/api/customer-automation*`: `P2` / `phase_5_external_adapter` / `external_side_effect` / owner `aicrm_next.automation_engine`
- `LRB-127` `/api/customers/automation/signup-conversion/batches*`: `P1` / `phase_4_internal_write` / `readonly` / owner `aicrm_next.automation_engine`
- `LRB-128` `/api/customers/automation/activation-webhook`: `P2` / `keep_guarded_until_adapter_ready` / `blocked_or_guarded` / owner `aicrm_next.automation_engine`
- `LRB-129` `/api/customers/automation/webhook-deliveries`: `P3` / `phase_6_timer_automation` / `timer_or_automation_execution` / owner `aicrm_next.automation_engine`
- `LRB-130` `/api/customers/automation/webhook-deliveries/{delivery_id}/retry`: `P2` / `keep_guarded_until_adapter_ready` / `blocked_or_guarded` / owner `aicrm_next.automation_engine`
- `LRB-131` `/api/customers/automation/webhook-deliveries/retry-due`: `P2` / `keep_guarded_until_adapter_ready` / `blocked_or_guarded` / owner `aicrm_next.automation_engine`
- `LRB-132` `/api/admin/wechat-pay/products*`: `P2` / `phase_5_external_adapter` / `external_side_effect` / owner `aicrm_next.commerce`
- `LRB-133` `/api/admin/wechat-pay*`: `P2` / `phase_5_external_adapter` / `adapter_contract` / owner `aicrm_next.commerce`
- `LRB-134` `/api/admin/alipay*`: `P2` / `phase_5_external_adapter` / `adapter_contract` / owner `aicrm_next.commerce`
- `LRB-135` `/api/products*`: `P2` / `phase_5_external_adapter` / `external_side_effect` / owner `aicrm_next.public_product`
- `LRB-136` `/p/{page_slug}`: `P2` / `phase_5_external_adapter` / `external_side_effect` / owner `aicrm_next.public_product`
- `LRB-137` `/pay/{product_code}`: `P2` / `phase_5_external_adapter` / `external_side_effect` / owner `aicrm_next.public_product`
- `LRB-138` `/api/orders*`: `P2` / `phase_5_external_adapter` / `external_side_effect` / owner `aicrm_next.commerce`
- `LRB-139` `/api/checkout*`: `P2` / `phase_5_external_adapter` / `adapter_contract` / owner `aicrm_next.commerce`
- `LRB-140` `/api/wechat-pay*`: `P2` / `phase_5_external_adapter` / `adapter_contract` / owner `aicrm_next.commerce`
- `LRB-141` `/api/alipay*`: `P2` / `phase_5_external_adapter` / `adapter_contract` / owner `aicrm_next.commerce`
- `LRB-142` `/api/h5/wechat-pay*`: `P2` / `phase_5_external_adapter` / `external_side_effect` / owner `aicrm_next.commerce`
- `LRB-143` `/api/h5/alipay*`: `P2` / `phase_5_external_adapter` / `external_side_effect` / owner `aicrm_next.commerce`
- `LRB-144` `/api/admin/image-library*`: `P2` / `phase_5_external_adapter` / `adapter_contract` / owner `aicrm_next.media_library`
- `LRB-145` `/api/admin/image-library/upload`: `P2` / `phase_5_external_adapter` / `external_side_effect` / owner `aicrm_next.media_library`
- `LRB-146` `/api/admin/attachment-library*`: `P2` / `phase_5_external_adapter` / `adapter_contract` / owner `aicrm_next.media_library`
- `LRB-147` `/api/admin/miniprogram-library*`: `P2` / `phase_5_external_adapter` / `adapter_contract` / owner `aicrm_next.media_library`
- `LRB-148` `/sidebar/bind-mobile`: `P0` / `phase_3_readonly` / `shell_or_navigation` / owner `aicrm_next.frontend_compat`
- `LRB-149` `/api/sidebar/contact-binding-status`: `P0` / `phase_3_readonly` / `readonly` / owner `aicrm_next.identity_contact`
- `LRB-150` `/api/sidebar/binding-status`: `P0` / `phase_3_readonly` / `readonly` / owner `aicrm_next.identity_contact`
- `LRB-151` `/api/sidebar/customer-context`: `P0` / `phase_3_readonly` / `readonly` / owner `aicrm_next.customer_read_model`
- `LRB-152` `/api/sidebar/profile`: `P0` / `phase_3_readonly` / `readonly` / owner `aicrm_next.customer_read_model`
- `LRB-153` `/api/sidebar/tags`: `P0` / `phase_3_readonly` / `readonly` / owner `aicrm_next.customer_read_model`
- `LRB-154` `/api/admin/customers/profile`: `P0` / `phase_3_readonly` / `readonly` / owner `aicrm_next.customer_read_model`
- `LRB-155` `/api/admin/customers/profile/tags`: `P0` / `phase_3_readonly` / `readonly` / owner `aicrm_next.customer_read_model`
- `LRB-156` `/api/sidebar/bind-mobile`: `P2` / `keep_guarded_until_adapter_ready` / `blocked_or_guarded` / owner `aicrm_next.sidebar_write`
- `LRB-157` `/api/sidebar/jssdk-config`: `P2` / `keep_guarded_until_adapter_ready` / `blocked_or_guarded` / owner `aicrm_next.identity_contact`
- `LRB-158` `/api/sidebar/lead-pool/status`: `P0` / `phase_3_readonly` / `readonly` / owner `aicrm_next.automation_engine`
- `LRB-159` `/api/sidebar/lead-pool/upsert-class-term`: `P2` / `keep_guarded_until_adapter_ready` / `blocked_or_guarded` / owner `aicrm_next.sidebar_write`
- `LRB-160` `/api/sidebar/signup-tags/status`: `P0` / `phase_3_readonly` / `readonly` / owner `aicrm_next.customer_read_model`
- `LRB-161` `/api/sidebar/signup-tags/mark`: `P2` / `phase_5_external_adapter` / `external_side_effect` / owner `aicrm_next.sidebar_write`
- `LRB-162` `/api/sidebar/marketing-status`: `P0` / `phase_3_readonly` / `readonly` / owner `aicrm_next.customer_read_model`
- `LRB-163` `/api/sidebar/marketing-status/set-followup-segment`: `P2` / `keep_guarded_until_adapter_ready` / `blocked_or_guarded` / owner `aicrm_next.sidebar_write`
- `LRB-164` `/api/sidebar/marketing-status/mark-enrolled`: `P2` / `keep_guarded_until_adapter_ready` / `blocked_or_guarded` / owner `aicrm_next.sidebar_write`
- `LRB-165` `/api/sidebar/marketing-status/unmark-enrolled`: `P2` / `keep_guarded_until_adapter_ready` / `blocked_or_guarded` / owner `aicrm_next.sidebar_write`
- `LRB-166` `/api/sidebar/marketing-status*`: `P2` / `keep_guarded_until_adapter_ready` / `blocked_or_guarded` / owner `aicrm_next.automation_engine`
- `LRB-167` `/api/sidebar/v2/workbench`: `P2` / `keep_guarded_until_adapter_ready` / `blocked_or_guarded` / owner `aicrm_next.customer_read_model`
- `LRB-168` `/api/sidebar/v2/questionnaires`: `P2` / `keep_guarded_until_adapter_ready` / `blocked_or_guarded` / owner `aicrm_next.customer_read_model`
- `LRB-169` `/api/sidebar/v2/materials`: `P2` / `phase_5_external_adapter` / `external_side_effect` / owner `aicrm_next.customer_read_model`
- `LRB-170` `/api/sidebar/v2/materials/image/{image_id}/thumbnail`: `P2` / `phase_5_external_adapter` / `external_side_effect` / owner `aicrm_next.customer_read_model`
- `LRB-171` `/api/sidebar/v2/other-staff-messages`: `P2` / `keep_guarded_until_adapter_ready` / `blocked_or_guarded` / owner `aicrm_next.customer_read_model`
- `LRB-172` `/api/sidebar/v2/products`: `P2` / `phase_5_external_adapter` / `external_side_effect` / owner `aicrm_next.customer_read_model`
- `LRB-173` `/api/sidebar/v2/orders`: `P2` / `phase_5_external_adapter` / `external_side_effect` / owner `aicrm_next.customer_read_model`
- `LRB-174` `/api/sidebar/v2*`: `P2` / `phase_5_external_adapter` / `external_side_effect` / owner `aicrm_next.customer_read_model`
- `LRB-175` `/api/sidebar/v2/profile`: `P2` / `phase_5_external_adapter` / `external_side_effect` / owner `aicrm_next.sidebar_write`
- `LRB-176` `/api/sidebar/v2/materials/send`: `P2` / `keep_guarded_until_adapter_ready` / `blocked_or_guarded` / owner `aicrm_next.sidebar_write`
- `LRB-177` `/wecom/external-contact/callback`: `P2` / `phase_5_external_adapter` / `external_side_effect` / owner `aicrm_next.channel_entry`
- `LRB-178` `/api/wecom/events`: `P2` / `phase_5_external_adapter` / `external_side_effect` / owner `aicrm_next.channel_entry`
- `LRB-179` `/api/admin/channels/runtime-diagnosis`: `P1` / `phase_4_internal_write` / `readonly` / owner `aicrm_next.channel_entry`
- `LRB-180` `/api/admin/channels/{channel_id}/runtime-diagnosis`: `P1` / `phase_4_internal_write` / `readonly` / owner `aicrm_next.channel_entry`
- `LRB-181` `/api/admin/channels/{channel_id}/qrcode/generate`: `P2` / `phase_5_external_adapter` / `external_side_effect` / owner `aicrm_next.channel_entry`
- `LRB-182` `/api/admin/channels/repair-entry`: `P1` / `phase_4_internal_write` / `readonly` / owner `aicrm_next.channel_entry`
- `LRB-183` `/admin/hxc-dashboard`: `P0` / `phase_3_readonly` / `readonly` / owner `aicrm_next.hxc_dashboard`
- `LRB-184` `/admin/hxc-send-config`: `P0` / `phase_3_readonly` / `readonly` / owner `aicrm_next.hxc_dashboard`
- `LRB-185` `/api/admin/hxc-dashboard`: `P0` / `phase_3_readonly` / `readonly` / owner `aicrm_next.hxc_dashboard`
- `LRB-186` `/api/admin/hxc-dashboard/refresh`: `P2` / `phase_5_external_adapter` / `external_side_effect` / owner `aicrm_next.hxc_dashboard`
- `LRB-187` `/api/admin/hxc-dashboard/refresh-directory`: `P2` / `phase_5_external_adapter` / `external_side_effect` / owner `aicrm_next.hxc_dashboard`
- `LRB-188` `/api/admin/hxc-dashboard/send-config`: `P0` / `phase_3_readonly` / `readonly` / owner `aicrm_next.hxc_dashboard`
- `LRB-189` `/api/admin/hxc-dashboard/send-config`: `P2` / `phase_5_external_adapter` / `external_side_effect` / owner `aicrm_next.hxc_dashboard`
- `LRB-190` `/api/admin/hxc-dashboard/send-config/{sender_userid}`: `P2` / `phase_5_external_adapter` / `external_side_effect` / owner `aicrm_next.hxc_dashboard`
- `LRB-191` `/api/admin/hxc-dashboard/broadcast`: `P2` / `phase_5_external_adapter` / `external_side_effect` / owner `aicrm_next.hxc_dashboard`
- `LRB-192` `/api/admin/hxc-dashboard/{unknown_path}`: `P0` / `phase_3_readonly` / `readonly` / owner `aicrm_next.hxc_dashboard`
- `LRB-193` `/mcp`: `P2` / `phase_5_external_adapter` / `adapter_contract` / owner `aicrm_next.integration_gateway`
- `LRB-194` `/api/admin/class-user-management/export`: `P2` / `keep_guarded_until_adapter_ready` / `blocked_or_guarded` / owner `aicrm_next.post_legacy_deferred`
- `LRB-195` `/api/admin/cloud-orchestrator/audit`: `P2` / `keep_guarded_until_adapter_ready` / `blocked_or_guarded` / owner `aicrm_next.cloud_orchestrator`
- `LRB-196` `/api/admin/cloud-orchestrator/observability`: `P2` / `keep_guarded_until_adapter_ready` / `blocked_or_guarded` / owner `aicrm_next.cloud_orchestrator`
- `LRB-197` `/api/admin/wecom-customer-acquisition-links`: `P2` / `phase_5_external_adapter` / `external_side_effect` / owner `aicrm_next.post_legacy_deferred`
- `LRB-198` `/api/admin/wecom-customer-acquisition-links/{link_id}`: `P2` / `phase_5_external_adapter` / `external_side_effect` / owner `aicrm_next.post_legacy_deferred`
- `LRB-199` `/api/admin/wecom-customer-acquisition-links/{link_id}/{action}`: `P2` / `phase_5_external_adapter` / `external_side_effect` / owner `aicrm_next.post_legacy_deferred`
