...
| --- | --- | --- | --- | --- |
| `payment.legacy_direct_automation` | `payment.succeeded` | `automation_payment_consumer` | `public_product.h5_wechat_pay` | payment direct automation hits after internal event coverage |
