...
| D7 | Write/external adapters | Next adapters, if approved | legacy write/external routes | planning in progress | D7.1 Media adapter contract first; no deletion until replacement evidence |
