...
Generated: 2026-06-29T08:55:00Z
...
The active hand-written inventory set currently contains 19 `*_route_inventory.md` files.
The archived manifest-derivable inventory set currently contains 5 `*_route_inventory.md` files.
...
| `docs/architecture/cloud_orchestrator_campaigns_route_inventory.md` | `active` | 16 | 12 | 3 | 0 | Contains wildcard/family refs or route refs not exactly covered by the manifest. |
| `docs/architecture/hxc_dashboard_route_inventory.md` | `active` | 13 | 10 | 1 | 0 | Contains wildcard/family refs or route refs not exactly covered by the manifest. |
| `docs/architecture/media_library_route_inventory.md` | `active` | 31 | 21 | 4 | 12 | Contains wildcard/family refs or route refs not exactly covered by the manifest. |
...
| `docs/architecture/public_product_pay_route_inventory.md` | `active` | 19 | 0 | 11 | 0 | Contains wildcard/family refs or route refs not exactly covered by the manifest. |
| `docs/architecture/questionnaire_admin_read_route_inventory.md` | `active` | 17 | 14 | 2 | 3 | Contains wildcard/family refs or route refs not exactly covered by the manifest. |
...
| `docs/architecture/wecom_tag_read_route_inventory.md` | `active` | 18 | 10 | 2 | 6 | Contains wildcard/family refs or route refs not exactly covered by the manifest. |
...
| Inventory | Location | Routes | Exact manifest matches | Wildcard/family refs | Test refs | Reason |
| --- | --- | ---: | ---: | ---: | ---: | --- |
| `docs/architecture/customer_automation_webhook_route_inventory.md` | `active` | 0 | 0 | 0 | 0 | No route-like backtick paths were extracted. |
| `docs/architecture/wecom_tag_live_mutation_route_inventory.md` | `active` | 0 | 0 | 0 | 4 | No route-like backtick paths were extracted. |
