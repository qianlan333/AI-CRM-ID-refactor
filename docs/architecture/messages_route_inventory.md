...
- `tests/test_api.py`, `tests/contract/test_crm_contract.py`, and `tests/test_messages_exact_routes.py` reference `GET /api/messages/{external_userid}`, `GET /api/messages/{external_userid}/recent`, and `GET /api/messages/search`.
