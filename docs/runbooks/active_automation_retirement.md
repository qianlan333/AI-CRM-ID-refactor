...
- `/api/admin/automation-conversion/jobs/run-due` 必须返回 `410 legacy_automation_jobs_runner_retired`。
- `/api/admin/automation-conversion/jobs/run-due/preview` 必须返回 `410 legacy_automation_jobs_runner_retired`。
