...
DEFAULT_LOBSTER_CENTRAL_ROUTER_URL = DEFAULT_OPENCLAW_WEBHOOK_URL
...
_SETTING_KEY_ALIASES = {
    ...
    "LOBSTER_CENTRAL_ROUTER_URL": ("OPENCLAW_WEBHOOK_URL", "OPENCLAW_FOCUS_MESSAGE_WEBHOOK_URL"),
    "LOBSTER_CENTRAL_ROUTER_TOKEN": ("OPENCLAW_FOCUS_MESSAGE_WEBHOOK_TOKEN",),
    "LOBSTER_CENTRAL_ROUTER_TIMEOUT_SECONDS": ("OPENCLAW_FOCUS_MESSAGE_WEBHOOK_TIMEOUT_SECONDS",),
}
