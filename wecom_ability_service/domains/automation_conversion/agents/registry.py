...
SKILL_REGISTRY_DEFINITIONS = (
    ...
    },
    {
        ...
        "example_request": {"external_contact_id": "wm_agent_route_001"},
        "example_response": {"member_exists": True, "stage": {"current_pool": "inactive_normal"}},
    },
    {
        "skill_code": "crm.get_member_questionnaire",
        "agent_code": "shared",
        "pool_keys": list(_CRM_SKILL_POOL_KEYS),
        "read_capabilities": ["questionnaire_status", "questionnaire_result"],
        "write_capabilities": [],
        "enabled": True,
        "input_schema": {"external_contact_id": "string", "phone": "string"},
        "output_schema": {"member_exists": "boolean", "questionnaire": "object"},
        "permission_notes": "只读查询问卷状态、结果和命中题目。",
        "idempotency_notes": "纯读取，无需幂等键。",
        "audit_notes": "记录问卷读取来源。",
        "example_request": {"external_contact_id": "wm_agent_route_001"},
        "example_response": {"member_exists": True, "questionnaire": {"result": "focus"}},
    },
    {
    ...
    },
    {
        ...
        "example_request": {"external_contact_id": "wm_agent_route_001"},
        "example_response": {"member_exists": True, "stage": {"current_stage": "inactive_normal_followup"}},
    },
    {
    ...
    },
    {
        ...
        "pool_keys": [],
        "read_capabilities": [],
        "write_capabilities": ["create_agent", "draft_prompt", "draft_variables", "draft_output_schema"],
        "enabled": True,
        "input_schema": {
            "agent_code": "string",
            "display_name": "string",
        ...
        "output_schema": {"created": "boolean", "agent": "object"},
        "permission_notes": "创建新的 child agent 草稿，不会自动发布到线上执行。",
    ...
    },
    {
        ...
        "agent_code": "shared",
        "pool_keys": [],
        "read_capabilities": ["all_role_prompts", "all_task_prompts", "all_variables", "all_output_schema"],
        "write_capabilities": [],
        "enabled": True,
        "input_schema": {"enabled_only": "boolean", "request_id": "string", "operator": "string", "idempotency_key": "string"},
    ...
    },
    {
        ...
        "write_capabilities": ["draft_prompt", "draft_variables", "draft_output_schema"],
        "enabled": True,
        "input_schema": {"agent_code": "string", "patch": "object", "role_prompt": "string", "task_prompt": "string", "variables": "array", "output_schema": "array", "expected_draft_version": "integer", "request_id": "string", "operator": "string", "change_summary": "string", "idempotency_key": "string"},
        ...
        "example_request": {"agent_code": "pricing_agent", "task_prompt": "更新后的任务提示词", "expected_draft_version": 3, "change_summary": "收紧价格话术", "idempotency_key": "draft-001"},
