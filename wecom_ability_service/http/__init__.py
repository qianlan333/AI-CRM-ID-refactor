...
HTTP_ROUTE_MODULES = {
    ...
    "channel_runtime_diagnosis": "wecom_ability_service.http.channel_runtime_diagnosis",
...
HTTP_ROUTE_PLACEMENT = {
    ...
    "admin": (
        ...
        "channel_runtime_diagnosis.py for channel runtime diagnosis, dry-run, and repair handlers registered by automation_conversion.py",
