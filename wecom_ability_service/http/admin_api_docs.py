...
def _followup_orchestrator_group() -> dict:
    return {
        "id": "followup-orchestrator",
        "title": "跟进编排",
        "description": "跟进任务的编排和执行，支持预览、执行和撤销操作。mission_key 为跟进任务的唯一标识。",
        "endpoints": [
            {"id": "get-fo-list", "method": "GET", "path": "/api/admin/followup-orchestrator", "summary": "获取跟进任务列表", "description": "返回跟进任务列表，支持按范围、负责人和联系人过滤。", "auth": "session", "params": [{"name": "scope", "type": "string", "required": False, "description": "范围过滤"}, {"name": "owner_userid", "type": "string", "required": False, "description": "负责人过滤"}, {"name": "external_userid", "type": "string", "required": False, "description": "联系人过滤"}, {"name": "limit", "type": "int", "required": False, "description": "返回条数"}], "request_example": "GET /api/admin/followup-orchestrator?limit=20", "response_example": '{"ok": true, "orchestrator": {"missions": [...]}}', "curl_example": _curl("GET", "/api/admin/followup-orchestrator?limit=20", "session")},
            {"id": "get-fo-customer", "method": "GET", "path": "/api/admin/followup-orchestrator/customers/<external_userid>", "summary": "获取客户跟进状态", "description": "返回指定客户的所有跟进任务和编排状态。", "auth": "session", "params": [{"name": "external_userid", "type": "string (path)", "required": True, "description": "外部联系人 ID"}], "request_example": None, "response_example": '{"ok": true, "customer_orchestrator": {...}}', "curl_example": _curl("GET", "/api/admin/followup-orchestrator/customers/wmXXX", "session")},
            {"id": "get-fo-mission", "method": "GET", "path": "/api/admin/followup-orchestrator/missions/<mission_key>", "summary": "获取跟进任务详情", "description": "返回单个跟进任务的完整信息和执行历史。", "auth": "session", "params": [{"name": "mission_key", "type": "string (path)", "required": True, "description": "任务唯一标识"}], "request_example": None, "response_example": '{"ok": true, "mission": {...}}', "curl_example": _curl("GET", "/api/admin/followup-orchestrator/missions/m_abc", "session")},
            {"id": "post-fo-mission-action", "method": "POST", "path": "/api/admin/followup-orchestrator/missions/<mission_key>/actions/<action_type>", "summary": "执行跟进任务动作", "description": "对跟进任务执行指定动作（如 complete、skip、escalate 等）。", "auth": "session", "params": [{"name": "mission_key", "type": "string (path)", "required": True, "description": "任务标识"}, {"name": "action_type", "type": "string (path)", "required": True, "description": "动作类型"}, {"name": "note", "type": "string", "required": False, "description": "备注"}], "request_example": None, "response_example": '{"ok": true, "mission_key": "m_abc", "action_type": "complete", "result": {...}}', "curl_example": _curl("POST", "/api/admin/followup-orchestrator/missions/m_abc/actions/complete", "session", '{"note":"已联系"}')},
            {"id": "post-fo-item-preview", "method": "POST", "path": "/api/admin/followup-orchestrator/missions/<mission_key>/items/<mission_item_key>/actions/preview", "summary": "预览跟进项动作", "description": "预览对跟进子项执行动作的效果。", "auth": "session", "params": [{"name": "mission_key", "type": "string (path)", "required": True, "description": "任务标识"}, {"name": "mission_item_key", "type": "string (path)", "required": True, "description": "子项标识"}, {"name": "action_type", "type": "string", "required": True, "description": "动作类型"}], "request_example": None, "response_example": '{"ok": true, "preview": {...}}', "curl_example": _curl("POST", "/api/admin/followup-orchestrator/missions/m_abc/items/i_1/actions/preview", "session", '{"action_type":"execute"}')},
            {"id": "post-fo-item-execute", "method": "POST", "path": "/api/admin/followup-orchestrator/missions/<mission_key>/items/<mission_item_key>/actions/execute", "summary": "执行跟进项动作", "description": "执行跟进子项的动作（如发送消息、打标签等）。", "auth": "session", "params": [{"name": "mission_key", "type": "string (path)", "required": True, "description": "任务标识"}, {"name": "mission_item_key", "type": "string (path)", "required": True, "description": "子项标识"}, {"name": "action_type", "type": "string", "required": True, "description": "动作类型"}, {"name": "note", "type": "string", "required": False, "description": "备注"}], "request_example": None, "response_example": '{"ok": true, "result": {...}}', "curl_example": _curl("POST", "/api/admin/followup-orchestrator/missions/m_abc/items/i_1/actions/execute", "session", '{"action_type":"send_message"}')},
            {"id": "post-fo-item-undo", "method": "POST", "path": "/api/admin/followup-orchestrator/missions/<mission_key>/items/<mission_item_key>/actions/undo", "summary": "撤销跟进项执行", "description": "撤销已执行的跟进子项动作。", "auth": "session", "params": [{"name": "mission_key", "type": "string (path)", "required": True, "description": "任务标识"}, {"name": "mission_item_key", "type": "string (path)", "required": True, "description": "子项标识"}, {"name": "execution_id", "type": "int", "required": True, "description": "要撤销的执行 ID"}], "request_example": None, "response_example": '{"ok": true, "result": {...}}', "curl_example": _curl("POST", "/api/admin/followup-orchestrator/missions/m_abc/items/i_1/actions/undo", "session", '{"execution_id":123}')},
        ],
    }


def _customer_pulse_group() -> dict:
    return {
        "id": "customer-pulse",
        "title": "客户脉搏",
        "description": "客户脉搏智能卡片系统：自动分析客户状态变化，生成可执行的跟进建议卡片。支持预览、执行、反馈和撤销。",
        "endpoints": [
            {"id": "get-pulse-list", "method": "GET", "path": "/api/admin/customer-pulse", "summary": "获取脉搏卡片列表", "description": "返回脉搏收件箱中的卡片列表，支持多维度过滤。", "auth": "session", "params": [{"name": "owner_userid", "type": "string", "required": False, "description": "按负责人过滤"}, {"name": "external_userid", "type": "string", "required": False, "description": "按联系人过滤"}, {"name": "stage", "type": "string", "required": False, "description": "按阶段过滤"}, {"name": "risk", "type": "string", "required": False, "description": "按风险等级过滤"}, {"name": "search", "type": "string", "required": False, "description": "搜索关键词"}, {"name": "overdue_only", "type": "boolean", "required": False, "description": "仅显示逾期"}, {"name": "high_priority_only", "type": "boolean", "required": False, "description": "仅显示高优先级"}], "request_example": "GET /api/admin/customer-pulse?high_priority_only=true", "response_example": '{"ok": true, "inbox": {"cards": [...], "total": 15}}', "curl_example": _curl("GET", "/api/admin/customer-pulse?high_priority_only=true", "session")},
            {"id": "get-pulse-stats", "method": "GET", "path": "/api/admin/customer-pulse/stats", "summary": "获取脉搏统计", "description": "返回脉搏系统的统计数据概览。", "auth": "session", "params": [{"name": "days", "type": "int", "required": False, "description": "统计天数，默认 7"}], "request_example": None, "response_example": '{"ok": true, "stats": {"total_cards": 50, "actioned": 30}}', "curl_example": _curl("GET", "/api/admin/customer-pulse/stats?days=7", "session")},
            {"id": "get-pulse-card", "method": "GET", "path": "/api/admin/customer-pulse/cards/<int:card_id>", "summary": "获取脉搏卡片详情", "description": "返回单张脉搏卡片的完整信息。", "auth": "session", "params": [{"name": "card_id", "type": "int (path)", "required": True, "description": "卡片 ID"}], "request_example": None, "response_example": '{"ok": true, "card": {...}}', "curl_example": _curl("GET", "/api/admin/customer-pulse/cards/1", "session")},
            {"id": "get-pulse-card-evidence", "method": "GET", "path": "/api/admin/customer-pulse/cards/<int:card_id>/evidence", "summary": "获取脉搏卡片证据", "description": "返回触发该卡片生成的原始证据数据（消息、事件等）。", "auth": "session", "params": [{"name": "card_id", "type": "int (path)", "required": True, "description": "卡片 ID"}], "request_example": None, "response_example": '{"ok": true, "evidence": [...]}', "curl_example": _curl("GET", "/api/admin/customer-pulse/cards/1/evidence", "session")},
            {"id": "post-pulse-refresh", "method": "POST", "path": "/api/admin/customer-pulse/actions/refresh", "summary": "刷新脉搏数据", "description": "手动触发脉搏数据刷新。可选指定负责人或联系人范围。", "auth": "session", "params": [{"name": "owner_userid", "type": "string", "required": False, "description": "指定负责人"}, {"name": "external_userid", "type": "string", "required": False, "description": "指定联系人"}], "request_example": None, "response_example": '{"ok": true, "result": {"refreshed": 5}}', "curl_example": _curl("POST", "/api/admin/customer-pulse/actions/refresh", "session")},
            {"id": "post-pulse-preview", "method": "POST", "path": "/api/admin/customer-pulse/cards/<int:card_id>/actions/preview", "summary": "预览卡片动作", "description": "预览对脉搏卡片执行动作的效果。", "auth": "session", "params": [{"name": "card_id", "type": "int (path)", "required": True, "description": "卡片 ID"}, {"name": "action_type", "type": "string", "required": True, "description": "动作类型"}], "request_example": None, "response_example": '{"ok": true, "preview": {...}}', "curl_example": _curl("POST", "/api/admin/customer-pulse/cards/1/actions/preview", "session", '{"action_type":"send_message"}')},
            {"id": "post-pulse-execute", "method": "POST", "path": "/api/admin/customer-pulse/cards/<int:card_id>/actions/execute", "summary": "执行卡片动作", "description": "执行脉搏卡片建议的跟进动作。", "auth": "session", "params": [{"name": "card_id", "type": "int (path)", "required": True, "description": "卡片 ID"}, {"name": "action_type", "type": "string", "required": True, "description": "动作类型"}, {"name": "action_payload", "type": "object", "required": False, "description": "动作参数"}], "request_example": None, "response_example": '{"ok": true, "execution_id": 42, "execution_status": "completed"}', "curl_example": _curl("POST", "/api/admin/customer-pulse/cards/1/actions/execute", "session", '{"action_type":"send_message"}')},
            {"id": "post-pulse-feedback", "method": "POST", "path": "/api/admin/customer-pulse/cards/<int:card_id>/feedback", "summary": "反馈卡片质量", "description": "对脉搏卡片的建议质量进行反馈（有用/无用）。", "auth": "session", "params": [{"name": "card_id", "type": "int (path)", "required": True, "description": "卡片 ID"}, {"name": "feedback_type", "type": "string", "required": True, "description": "反馈类型（helpful / not_helpful）"}], "request_example": None, "response_example": '{"ok": true, "feedback_id": 1}', "curl_example": _curl("POST", "/api/admin/customer-pulse/cards/1/feedback", "session", '{"feedback_type":"helpful"}')},
            {"id": "post-pulse-undo", "method": "POST", "path": "/api/admin/customer-pulse/executions/<int:execution_id>/undo", "summary": "撤销卡片执行", "description": "撤销已执行的脉搏卡片动作。", "auth": "session", "params": [{"name": "execution_id", "type": "int (path)", "required": True, "description": "执行 ID"}], "request_example": None, "response_example": '{"ok": true, "execution_status": "undone"}', "curl_example": _curl("POST", "/api/admin/customer-pulse/executions/42/undo", "session")},
        ],
    }
...
def _api_endpoint_groups() -> list[dict]:
    return [
        ...
        _automation_group(),
        _followup_orchestrator_group(),
        _customer_pulse_group(),
        _config_group(),
        _user_ops_group(),
        _class_user_group(),
        _sidebar_group(),
