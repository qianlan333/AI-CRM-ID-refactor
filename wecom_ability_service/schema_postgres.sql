...
CREATE INDEX IF NOT EXISTS idx_automation_event_v2_program_event
ON automation_event_v2 (program_id, event_type, occurred_at);

CREATE INDEX IF NOT EXISTS idx_automation_event_v2_external
ON automation_event_v2 (external_userid);
...
CREATE INDEX IF NOT EXISTS idx_automation_membership_v2_program_stage
ON automation_membership_v2 (program_id, current_stage, status);
...
CREATE INDEX IF NOT EXISTS idx_automation_stage_entry_v2_program_stage
ON automation_stage_entry_v2 (program_id, stage_code, entered_at);
...
CREATE UNIQUE INDEX IF NOT EXISTS uq_automation_task_plan_v2_event
ON automation_task_plan_v2 (task_id, membership_id, event_id)
WHERE event_id IS NOT NULL;

CREATE UNIQUE INDEX IF NOT EXISTS uq_automation_task_plan_v2_stage
ON automation_task_plan_v2 (task_id, membership_id, stage_entry_id)
WHERE stage_entry_id IS NOT NULL;

CREATE UNIQUE INDEX IF NOT EXISTS uq_automation_task_plan_v2_schedule
ON automation_task_plan_v2 (task_id, membership_id, schedule_key)
WHERE schedule_key <> '';

CREATE INDEX IF NOT EXISTS idx_automation_task_plan_v2_program_status
ON automation_task_plan_v2 (program_id, status, created_at);
...
CREATE UNIQUE INDEX IF NOT EXISTS uq_wechat_shop_orders_order_id
ON wechat_shop_orders (order_id);

CREATE INDEX IF NOT EXISTS idx_wechat_shop_orders_provider_created
ON wechat_shop_orders (provider, created_at DESC, id DESC);

CREATE INDEX IF NOT EXISTS idx_wechat_shop_orders_business_status_created
ON wechat_shop_orders (business_status, created_at DESC);
...
CREATE INDEX IF NOT EXISTS idx_wechat_shop_orders_unionid
ON wechat_shop_orders (unionid)
WHERE unionid <> '';
...
CREATE INDEX IF NOT EXISTS idx_wechat_shop_order_events_order
ON wechat_shop_order_events (order_id, created_at DESC);

CREATE INDEX IF NOT EXISTS idx_wechat_shop_order_events_type
ON wechat_shop_order_events (event_type, created_at DESC);
