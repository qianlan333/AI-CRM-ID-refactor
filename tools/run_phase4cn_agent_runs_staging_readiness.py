...
STAGING_DB_ENV = "AICRM_AGENT_RUNS_STAGING_DATABASE_URL"
REPO_BACKEND_ENV = "AICRM_AGENT_RUNS_REPO_BACKEND"
SMOKE_APPROVAL_ENV = "AICRM_PHASE4CN_STAGING_SMOKE_APPROVED"
WRITE_APPROVAL_ENV = "AICRM_PHASE4CN_STAGING_WRITE_APPROVED"
...
SIDE_EFFECT_SAFETY = {
    ...
    "run_creation_executed": False,
    "run_execution_executed": False,
    "replay_execution_executed": False,
    "orchestration_execution_executed": False,
    "agent_run_execution_executed": False,
    "llm_generation_executed": False,
    "deepseek_adapter_executed": False,
...
def _write_outputs(report: dict[str, Any], output_json: str | None, output_md: str | None) -> None:
    ...
    if output_md:
        lines = [
            "# Phase 4CN Agent Runs Staging Readiness",
            "",
