...
RESOLUTION_SAMPLES = [
    ...
    ("POST", "/api/admin/automation-conversion/settings/default-channel/generate"),
    ("GET", "/api/admin/automation-conversion/default-channel-settings"),
    ("POST", "/api/admin/automation-conversion/default-channel-settings/generate-qr"),
