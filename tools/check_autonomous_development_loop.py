...
def build_report() -> dict[str, Any]:
    ...
    if state.get("current_phase") != "post_phase7_cleanup_workflow_nodes_evidence_refresh":
        blockers.append("current_phase must be post_phase7_cleanup_workflow_nodes_evidence_refresh")
    if state.get("active_candidate") != "workflow_nodes_cleanup_evidence_refresh":
        blockers.append("active_candidate must select workflow-nodes cleanup evidence refresh")
    ...
    if state.get("last_merged_pr") != "#798":
        blockers.append("last_merged_pr must record latest completed merged PR #798")
