...
def build_report() -> dict[str, Any]:
    ...
    if state.get("current_phase") != "post_phase7_first_new_feature_intake":
        blockers.append("current_phase must be post_phase7_first_new_feature_intake")
    if state.get("active_candidate") != "post_phase7_feature_intake":
        blockers.append("active_candidate must select Post-Phase 7 feature intake")
    ...
    if state.get("last_merged_pr") != "#794":
        blockers.append("last_merged_pr must record latest completed merged PR #794")
