...
ALLOWED_NEXT_ACTIONS = {
    "phase_4au_workflows_fixture_native_implementation_owner_decision",
}
...
def build_report() -> dict[str, Any]:
    ...
    if state.get("last_merged_pr") != "#650":
        blockers.append("last_merged_pr must record latest completed autopilot PR #650")
