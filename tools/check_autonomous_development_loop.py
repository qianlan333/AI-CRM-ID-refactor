...
def build_report() -> dict[str, Any]:
    ...
    if state.get("active_candidate") != "legacy_runtime_recheck_after_agent_outputs_exact_cleanup":
        blockers.append("active_candidate must select post-#820 legacy runtime recheck")
    ...
    if state.get("last_merged_pr") != "#820":
        blockers.append("last_merged_pr must record latest cleanup PR #820")
