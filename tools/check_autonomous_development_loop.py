...
def build_report() -> dict[str, Any]:
    ...
    if state.get("current_phase") != "post_phase7_owner_approved_cleanup_track_activation":
        blockers.append("current_phase must be post_phase7_owner_approved_cleanup_track_activation")
    if state.get("active_candidate") != "post_phase7_owner_approved_cleanup_track":
        blockers.append("active_candidate must select Post-Phase 7 owner-approved cleanup track")
    ...
    if state.get("last_merged_pr") != "#796":
        blockers.append("last_merged_pr must record latest completed merged PR #796")
