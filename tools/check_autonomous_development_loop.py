...
def build_report() -> dict[str, Any]:
    ...
    if state.get("current_phase") != "post_phase7_cleanup_blocker_acceptance":
        blockers.append("current_phase must be post_phase7_cleanup_blocker_acceptance")
    if state.get("active_candidate") != "cleanup_blocker_acceptance":
        blockers.append("active_candidate must select cleanup blocker acceptance")
    ...
    if state.get("last_merged_pr") != "#799":
        blockers.append("last_merged_pr must record latest completed merged PR #799")
