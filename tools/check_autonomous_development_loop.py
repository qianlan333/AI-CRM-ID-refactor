...
def build_report() -> dict[str, Any]:
    ...
    if state.get("current_phase") != "post_phase7_cleanup_owner_evidence_collection":
        blockers.append("current_phase must be post_phase7_cleanup_owner_evidence_collection")
    if state.get("active_candidate") != "cleanup_owner_evidence_collection":
        blockers.append("active_candidate must select cleanup owner evidence collection")
    ...
    if state.get("last_merged_pr") != "#801":
        blockers.append("last_merged_pr must record latest completed merged PR #801")
