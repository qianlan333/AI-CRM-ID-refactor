...
def build_report() -> dict[str, Any]:
    ...
    if state.get("current_phase") != "post_phase7_cleanup_owner_evidence_waiting_acceptance":
        blockers.append("current_phase must be post_phase7_cleanup_owner_evidence_waiting_acceptance")
    if state.get("active_candidate") != "cleanup_owner_evidence_waiting_acceptance":
        blockers.append("active_candidate must select cleanup owner evidence waiting acceptance")
    ...
    if state.get("last_merged_pr") != "#802":
        blockers.append("last_merged_pr must record latest cleanup PR #802")
