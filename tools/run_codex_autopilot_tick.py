...
STOP_TERM_EXEMPT_WORK_PACKAGES = {
    ...
    "phase_7e_fallback_cleanup_readiness_bundle",
    "phase_7f_production_compat_cleanup_readiness_bundle",
    ...
    "phase_7k_final_route_ownership_manifest_cleanup_bundle",
    ...
    "post_phase7_owner_approved_cleanup_track_activation_bundle",
    "post_phase7_cleanup_task_groups_evidence_refresh_bundle",
    "post_phase7_cleanup_workflow_nodes_evidence_refresh_bundle",
    "post_phase7_cleanup_blocker_acceptance_bundle",
    "post_phase7_cleanup_owner_evidence_collection_bundle",
    ...
    "post_phase7_cleanup_workflow_nodes_owner_approved_cleanup_bundle",
