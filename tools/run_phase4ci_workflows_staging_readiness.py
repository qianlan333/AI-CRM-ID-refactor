...
STAGING_DB_ENV = "AICRM_WORKFLOWS_STAGING_DATABASE_URL"
REPO_BACKEND_ENV = "AICRM_WORKFLOWS_REPO_BACKEND"
SMOKE_APPROVAL_ENV = "AICRM_PHASE4CI_STAGING_SMOKE_APPROVED"
WRITE_APPROVAL_ENV = "AICRM_PHASE4CI_STAGING_WRITE_APPROVED"
...
def _write_outputs(report: dict[str, Any], output_json: str | None, output_md: str | None) -> None:
    ...
    if output_md:
        lines = [
            "# Phase 4CI Workflows Staging Readiness",
            "",
