...
STAGING_DB_ENV = "AICRM_AGENT_OUTPUTS_STAGING_DATABASE_URL"
REPO_BACKEND_ENV = "AICRM_AGENT_OUTPUTS_REPO_BACKEND"
SMOKE_APPROVAL_ENV = "AICRM_PHASE4CM_STAGING_SMOKE_APPROVED"
WRITE_APPROVAL_ENV = "AICRM_PHASE4CM_STAGING_WRITE_APPROVED"
...
SIDE_EFFECT_SAFETY = {
    ...
    "export_job_creation_executed": False,
...
def _write_outputs(report: dict[str, Any], output_json: str | None, output_md: str | None) -> None:
    ...
    if output_md:
        lines = [
            "# Phase 4CM Agent Outputs Staging Readiness",
            "",
