...
STAGING_DB_ENV = "AICRM_AGENTS_STAGING_DATABASE_URL"
REPO_BACKEND_ENV = "AICRM_AGENTS_REPO_BACKEND"
SMOKE_APPROVAL_ENV = "AICRM_PHASE4CL_STAGING_SMOKE_APPROVED"
WRITE_APPROVAL_ENV = "AICRM_PHASE4CL_STAGING_WRITE_APPROVED"
...
def _report(*, ok: bool, result_status: str, details: list[dict[str, Any]], execute_writes: bool) -> dict[str, Any]:
    return {
        ...
        "route_family": "/api/admin/automation-conversion/agents*",
...
def _write_outputs(report: dict[str, Any], output_json: str | None, output_md: str | None) -> None:
    ...
    if output_md:
        lines = [
            "# Phase 4CL Agents Staging Readiness",
            "",
