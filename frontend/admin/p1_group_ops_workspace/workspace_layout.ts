...
function renderLeftRailItem(item: WorkspaceListItem): string {
...
function renderLeftRail(fixture: WorkspaceFixture): string {
  return `
...
function renderPropertyPanel(fixture: WorkspaceFixture): string {
...
export function renderP1GroupOpsWorkspace(root: HTMLElement, fixture: WorkspaceFixture = P1_GROUP_OPS_WORKSPACE_FIXTURE): void {
