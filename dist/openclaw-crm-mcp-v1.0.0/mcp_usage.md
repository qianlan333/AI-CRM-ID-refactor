...
### 9. `get_hourly_followup_candidates`
...
但面向 OpenClaw 的推荐调用面，优先使用上面的最小业务工具。
...
5. `get_hourly_followup_candidates`
