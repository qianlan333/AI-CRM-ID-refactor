...
兼容工具如果远端仍提供，也会继续透传；但本包不在本地实现任何一条工具逻辑。
...
- `openclaw-crm-mcp-proxy-v2.0.0.tar.gz`
...
- 这是薄代理 MCP 包
- OpenClaw 本地只需要 `CRM_MCP_URL` 和 `MCP_BEARER_TOKEN`
- 旧的本地库模式包应彻底废弃
