...
def test_deploy_script_and_expression_length_guard_have_permanent_full_ci_scope() -> None:
    result = _select(
        ...
        "tests/test_id_validation_release_base_capture.py",
    ...
    assert "tests/test_id_validation_release_base_capture.py" in result["python_tests"]
