...
def test_runner_generates_phase_7c_prompt_without_github_when_no_open_pr(tmp_path: Path) -> None:
    ...
    assert "phase_7c_delete_ready_candidate_selection_bundle" in text
