...
def test_runner_generates_phase_7f_prompt_without_github_when_no_open_pr(tmp_path: Path) -> None:
    ...
    assert "phase_7f_production_compat_cleanup_readiness_bundle" in text
