...
def test_runner_generates_phase_7g_prompt_without_github_when_no_open_pr(tmp_path: Path) -> None:
    ...
    assert "phase_7g_first_exact_route_fallback_removal_canary_bundle" in text
