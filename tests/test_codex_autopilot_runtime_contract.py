...
def test_runner_generates_post_phase7_prompt_without_github_when_no_open_pr(tmp_path: Path) -> None:
    ...
    assert "post_phase7_cleanup_owner_evidence_waiting_acceptance_bundle" in text
