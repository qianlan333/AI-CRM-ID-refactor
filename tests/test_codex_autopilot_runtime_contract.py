...
def test_runner_generates_phase_7k_prompt_without_github_when_no_open_pr(tmp_path: Path) -> None:
    ...
    assert "phase_7k_final_route_ownership_manifest_cleanup_bundle" in text
