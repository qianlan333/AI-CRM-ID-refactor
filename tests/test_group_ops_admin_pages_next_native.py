...
def test_group_ops_admin_pages_render_from_next_native_bundle(monkeypatch) -> None:
    ...
    assert "/static/group-ops/admin_console/group_ops.css?v=group-ops-detail-clean-20260626" in detail_response.text
    assert "/static/group-ops/admin_console/group_ops.js?v=group-ops-detail-clean-20260626" in detail_response.text
    assert "group_ops.js?v=group-ops-create-legacy-20260601" not in detail_response.text
