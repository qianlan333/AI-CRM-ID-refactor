...
def test_phase_execution_state_fields_complete() -> None:
    ...
    assert data["current_phase"] == "post_phase7_new_feature_development_rules"
    assert data["active_candidate"] == "post_phase7_new_feature_development_governance"
    assert data["capability_owner"] == "aicrm_next.automation_engine"
    assert data["last_merged_pr"] == "#793"
