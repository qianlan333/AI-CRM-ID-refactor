...
def test_phase_execution_state_fields_complete() -> None:
    ...
    assert data["current_phase"] == "phase_7l_final_legacy_retirement_acceptance"
    assert data["active_candidate"] == "final_legacy_retirement_acceptance"
    assert data["capability_owner"] == "aicrm_next.automation_engine"
    assert data["last_merged_pr"] == "#792"
