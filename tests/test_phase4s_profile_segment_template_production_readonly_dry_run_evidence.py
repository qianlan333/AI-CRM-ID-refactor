...
CHECKER = ROOT / "tools/check_phase4s_profile_segment_template_production_readonly_dry_run_evidence.py"
...
PLAN_MD = ROOT / "docs/development/phase_4s_profile_segment_template_production_readonly_dry_run_evidence.md"
...
def _load_yaml() -> dict:
    return _load_module(CHECKER, "phase4s_checker").load_yaml(PLAN_YAML)
