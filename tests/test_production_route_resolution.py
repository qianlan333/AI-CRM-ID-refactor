...
def test_next_exact_routes_are_not_caught_by_production_compat_wildcards():
    ...
    assert _owner_for(samples, "GET", "/admin/customers/wx_ext_001") == "next"
    assert _endpoint_for(samples, "GET", "/admin/customers/wx_ext_001") == "aicrm_next.customer_read_model.admin_pages"
    assert _owner_for(samples, "GET", "/admin/user-ops/ui") == "next"
    assert _endpoint_for(samples, "GET", "/admin/user-ops/ui") == "aicrm_next.ops_enrollment.admin_pages"
    assert _owner_for(samples, "GET", "/admin/user-ops") == "next"
    assert _endpoint_for(samples, "GET", "/admin/user-ops") == "aicrm_next.ops_enrollment.admin_pages"
    assert _owner_for(samples, "GET", "/admin/runtime-config") == "next"
    assert _endpoint_for(samples, "GET", "/admin/runtime-config") == "aicrm_next.admin_config.api"
    assert _owner_for(samples, "GET", "/admin/api-docs") == "next"
    assert _endpoint_for(samples, "GET", "/admin/api-docs") == "aicrm_next.admin_config.api"
    ...
    assert _owner_for(samples, "GET", "/admin/cloud-orchestrator") == "next"
    assert _endpoint_for(samples, "GET", "/admin/cloud-orchestrator") == "aicrm_next.cloud_orchestrator.api"
    ...
    assert _owner_for(samples, "GET", "/admin/cloud-orchestrator/observability") == "next"
    assert _endpoint_for(samples, "GET", "/admin/cloud-orchestrator/observability") == "aicrm_next.cloud_orchestrator.api"
