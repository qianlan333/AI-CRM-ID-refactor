...
def test_phase5ah_openclaw_mcp_ai_assist_staging_canary_artifacts_can_define_stop_terms_as_policy() -> None:
    expected = {
...
def test_phase5aj_openclaw_mcp_ai_assist_family_acceptance_artifacts_can_define_stop_terms_as_policy() -> None:
    expected = {
...
def test_phase5ak_questionnaire_external_submit_contract_fake_stub_artifacts_can_define_stop_terms_as_policy() -> None:
    expected = {
...
def test_phase5ao_questionnaire_external_submit_family_acceptance_artifacts_can_define_stop_terms_as_policy() -> None:
    expected = {
...
def test_phase6a_owner_production_compat_artifacts_can_define_stop_terms_as_policy() -> None:
    expected = {
...
def test_phase6c_task_groups_tooling_artifacts_can_define_stop_terms_as_policy() -> None:
    expected = {
...
def test_phase6d_internal_metadata_batch_artifacts_can_define_stop_terms_as_policy() -> None:
    expected = {
...
def test_phase6h_production_compat_exact_route_readiness_artifacts_can_define_stop_terms_as_policy() -> None:
    expected = {
...
def test_phase6j_timer_execution_readiness_artifacts_can_define_stop_terms_as_policy() -> None:
    expected = {
...
def test_phase6k_single_scope_execution_canary_artifacts_can_define_stop_terms_as_policy() -> None:
    expected = {
    ...
    assert expected <= checker.POLICY_FILES_CAN_DEFINE_STOP_TERMS
    assert {"tools/run_phase6k_single_scope_execution_canary.py"} <= checker.LOW_RISK_EXACT


def test_phase6l_phase6_aggregate_acceptance_artifacts_can_define_stop_terms_as_policy() -> None:
    expected = {
