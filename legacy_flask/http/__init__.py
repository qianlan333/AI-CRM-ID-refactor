...
from wecom_ability_service.http.admin_jobs import register_routes as register_admin_jobs_console_routes
from wecom_ability_service.http.admin_broadcast_jobs import register_routes as register_admin_broadcast_jobs_routes
from wecom_ability_service.http.admin_customers import register_routes as register_admin_customer_console_routes
from wecom_ability_service.http.admin_audit import register_routes as register_admin_audit_console_routes
from wecom_ability_service.http.admin_api_docs import register_routes as register_admin_api_docs_routes
from wecom_ability_service.http.admin_auth_routes import register_routes as register_admin_auth_routes
from wecom_ability_service.http.admin_mcp import register_routes as register_admin_mcp_console_routes
from wecom_ability_service.http.admin_operations import register_routes as register_admin_operations_console_routes
try:
    from wecom_ability_service.http.admin_questionnaire_console import register_routes as register_admin_questionnaire_console_routes
except ModuleNotFoundError:  # pragma: no cover - compatibility shim for older file layout
    from wecom_ability_service.http.admin_questionnaires import register_routes as register_admin_questionnaire_console_routes
from wecom_ability_service.http.admin_questionnaire_push_logs import register_routes as register_admin_questionnaire_push_logs_routes
from wecom_ability_service.http.admin_config_api import register_routes as register_admin_config_api_routes
from wecom_ability_service.http.admin_config import register_routes as register_admin_config_routes
from wecom_ability_service.http.admin_config_login_access import register_routes as register_admin_config_login_access_routes
from wecom_ability_service.http.admin_config_marketing_automation import register_routes as register_admin_config_marketing_automation_routes
from wecom_ability_service.http.admin_console import register_routes as register_admin_console_routes
from wecom_ability_service.http.admin_dashboard import register_routes as register_admin_dashboard_routes
from wecom_ability_service.http.admin_class_user import register_routes as register_admin_class_user_routes
from wecom_ability_service.http.admin_hxc_dashboard import register_routes as register_admin_hxc_dashboard_routes
from wecom_ability_service.http.admin_questionnaires import register_routes as register_admin_questionnaires_routes
from wecom_ability_service.http.admin_alipay_pay import register_routes as register_admin_alipay_pay_routes
from wecom_ability_service.http.admin_wechat_pay import register_routes as register_admin_wechat_pay_routes
from wecom_ability_service.http.admin_wecom_tags import register_routes as register_admin_wecom_tags_routes
from wecom_ability_service.http.wecom_customer_acquisition import register_routes as register_wecom_customer_acquisition_routes
from wecom_ability_service.http.automation_conversion import register_routes as register_automation_conversion_routes
from wecom_ability_service.http.cloud_orchestrator_endpoint import register_routes as register_cloud_orchestrator_routes
from wecom_ability_service.http.archive import register_routes as register_archive_routes
from wecom_ability_service.http.callbacks import register_routes as register_callback_routes
from wecom_ability_service.http.contacts import register_routes as register_contacts_routes
from wecom_ability_service.http.customer_automation import register_routes as register_customer_automation_routes
from wecom_ability_service.http.group_chats import register_routes as register_group_chat_routes
from wecom_ability_service.http.identity import register_routes as register_identity_routes
from wecom_ability_service.http.ops import register_routes as register_ops_routes
from wecom_ability_service.http.public_questionnaire_oauth import register_routes as register_public_questionnaire_oauth_routes
from wecom_ability_service.http.public_questionnaires import register_routes as register_public_questionnaire_routes
from wecom_ability_service.http.public_questionnaire_diagnostics import register_routes as register_public_questionnaire_diagnostics_routes
from wecom_ability_service.http.alipay_pay import register_routes as register_alipay_pay_routes
from wecom_ability_service.http.wechat_pay import register_routes as register_wechat_pay_routes
from wecom_ability_service.http.settings_ops import register_routes as register_settings_routes
from wecom_ability_service.http.sidebar import register_routes as register_sidebar_routes
from wecom_ability_service.http.sidebar_marketing import register_routes as register_sidebar_marketing_routes
from wecom_ability_service.http.setup_wizard import register_routes as register_setup_wizard_routes
from wecom_ability_service.http.system_health import register_routes as register_system_health_routes
from wecom_ability_service.http.tags import register_routes as register_tag_routes
from wecom_ability_service.http.tasks import register_routes as register_task_routes
