...
from tools import seed_old_flask_customer_sample as seed_tool
...
def test_seed_default_is_dry_run_without_writes() -> None:
    ...
    assert result["sample"]["external_userid"] == "external_user_masked_001"
    assert "contact_tags" not in result["tables"]
