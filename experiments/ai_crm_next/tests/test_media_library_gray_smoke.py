...
def test_gray_release_plan_does_not_mark_production_ready() -> None:
    text = (PROJECT_ROOT / "docs" / "media_library_gray_release_plan.md").read_text(encoding="utf-8")
...
def test_media_gray_smoke_tool_does_not_import_old_backend() -> None:
    text = (PROJECT_ROOT / "tools" / "media_library_gray_smoke.py").read_text(encoding="utf-8")
