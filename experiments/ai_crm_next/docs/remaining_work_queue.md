...
- acceptance criteria: storage abstraction tests, file size/type checks, no real cloud default; `experiments/ai_crm_next/tools/media_library_gray_smoke.py` remains read-only by default and fake writes stay Next-only.
...
- files likely involved: `experiments/ai_crm_next/docs/gray_rehearsal_batch_1_media_readonly.md`, `experiments/ai_crm_next/docs/gray_rehearsal_batch_1_route_flags.md`, `experiments/ai_crm_next/docs/route_level_gray_release_batches.md`, `experiments/ai_crm_next/docs/route_level_gray_release_runbook.md`, `experiments/ai_crm_next/docs/gray_release_acceptance_checklist.md`, `experiments/ai_crm_next/docs/media_library_gray_release_plan.md`, `experiments/ai_crm_next/docs/media_library_route_cutover_manifest.md`, `experiments/ai_crm_next/tools/run_gray_rehearsal_batch.py`, `experiments/ai_crm_next/tools/media_library_gray_smoke.py`, `experiments/ai_crm_next/tools/generate_gray_release_report.py`, future deployment smoke scripts.
...
- files likely involved: `experiments/ai_crm_next/docs/route_level_gray_release_batches.md`, `experiments/ai_crm_next/docs/route_level_gray_release_runbook.md`, `experiments/ai_crm_next/docs/route_level_proxy_template.md`, `experiments/ai_crm_next/docs/gray_release_signoff_template.md`, `experiments/ai_crm_next/docs/gray_release_acceptance_checklist.md`, `experiments/ai_crm_next/tools/generate_gray_release_report.py`, `experiments/ai_crm_next/tests/test_gray_release_runbook.py`.
...
- files likely involved: `experiments/ai_crm_next/docs/staging_canary_topology.md`, `experiments/ai_crm_next/docs/batch_1_media_readonly_canary_plan.md`, `experiments/ai_crm_next/docs/batch_1_media_readonly_canary_runbook.md`, `experiments/ai_crm_next/docs/batch_1_media_readonly_proxy_pseudo_config.md`, `experiments/ai_crm_next/tools/check_batch_1_media_canary_readiness.py`, `experiments/ai_crm_next/tests/test_batch_1_media_canary_readiness.py`.
...
- files likely involved: `experiments/ai_crm_next/docs/batch_1_media_readonly_canary_execution_report.md`, `experiments/ai_crm_next/docs/batch_1_media_readonly_canary_signoff.md`, `experiments/ai_crm_next/docs/batch_1_media_readonly_canary_runbook.md`, `experiments/ai_crm_next/tools/media_library_gray_smoke.py`, `experiments/ai_crm_next/tools/check_batch_1_media_canary_readiness.py`.
...
- files likely involved: `experiments/ai_crm_next/docs/product_management_gray_release_plan.md`, `experiments/ai_crm_next/docs/product_management_route_cutover_manifest.md`, `experiments/ai_crm_next/tools/product_management_gray_smoke.py`, future deployment smoke scripts.
...
- files likely involved: `experiments/ai_crm_next/docs/batch_2_product_readonly_canary_execution_report.md`, `experiments/ai_crm_next/docs/batch_2_product_readonly_canary_signoff.md`, `experiments/ai_crm_next/docs/batch_2_product_readonly_canary_plan.md`, `experiments/ai_crm_next/docs/batch_2_product_readonly_canary_runbook.md`, `experiments/ai_crm_next/tools/product_management_gray_smoke.py`, `experiments/ai_crm_next/tools/check_batch_2_product_canary_readiness.py`.
...
- files likely involved: `experiments/ai_crm_next/docs/customer_read_model_gray_release_plan.md`, `experiments/ai_crm_next/docs/customer_read_model_route_cutover_manifest.md`, `experiments/ai_crm_next/docs/customer_read_model_sample_data_checklist.md`, `experiments/ai_crm_next/tools/customer_read_model_gray_smoke.py`, future deployment smoke scripts.
...
- files likely involved: `experiments/ai_crm_next/docs/batch_3_customer_readonly_canary_execution_report.md`, `experiments/ai_crm_next/docs/batch_3_customer_readonly_canary_signoff.md`, `experiments/ai_crm_next/docs/batch_3_customer_readonly_canary_plan.md`, `experiments/ai_crm_next/docs/batch_3_customer_readonly_canary_runbook.md`, `experiments/ai_crm_next/tools/customer_read_model_gray_smoke.py`, `experiments/ai_crm_next/tools/readonly_http_dual_run.py`, `experiments/ai_crm_next/tools/check_batch_3_customer_canary_readiness.py`.
...
- files likely involved: `experiments/ai_crm_next/docs/user_ops_readonly_gray_release_plan.md`, `experiments/ai_crm_next/docs/user_ops_readonly_route_cutover_manifest.md`, `experiments/ai_crm_next/docs/user_ops_readonly_sample_and_drift_checklist.md`, `experiments/ai_crm_next/docs/batch_4_user_ops_readonly_canary_plan.md`, `experiments/ai_crm_next/tools/user_ops_readonly_gray_smoke.py`, `experiments/ai_crm_next/tools/check_batch_4_user_ops_canary_readiness.py`.
...
- files likely involved: `experiments/ai_crm_next/docs/batch_4_user_ops_readonly_canary_execution_report.md`, `experiments/ai_crm_next/docs/batch_4_user_ops_readonly_canary_signoff.md`, `experiments/ai_crm_next/docs/batch_4_user_ops_readonly_canary_plan.md`, `experiments/ai_crm_next/docs/batch_4_user_ops_readonly_canary_runbook.md`, `experiments/ai_crm_next/tools/user_ops_readonly_gray_smoke.py`, `experiments/ai_crm_next/tools/readonly_http_dual_run.py`, `experiments/ai_crm_next/tools/check_batch_4_user_ops_canary_readiness.py`.
...
- files likely involved: `experiments/ai_crm_next/docs/questionnaire_readonly_gray_release_plan.md`, `experiments/ai_crm_next/docs/questionnaire_readonly_route_cutover_manifest.md`, `experiments/ai_crm_next/docs/questionnaire_readonly_sample_and_fake_checklist.md`, `experiments/ai_crm_next/docs/batch_5_questionnaire_readonly_canary_plan.md`, `experiments/ai_crm_next/tools/questionnaire_readonly_gray_smoke.py`, `experiments/ai_crm_next/tools/check_batch_5_questionnaire_canary_readiness.py`.
...
- files likely involved: `experiments/ai_crm_next/docs/batch_5_questionnaire_readonly_canary_execution_report.md`, `experiments/ai_crm_next/docs/batch_5_questionnaire_readonly_canary_signoff.md`, `experiments/ai_crm_next/docs/batch_5_questionnaire_readonly_canary_plan.md`, `experiments/ai_crm_next/docs/batch_5_questionnaire_readonly_canary_runbook.md`, `experiments/ai_crm_next/tools/questionnaire_readonly_gray_smoke.py`, `experiments/ai_crm_next/tools/check_batch_5_questionnaire_canary_readiness.py`.
...
- files likely involved: `experiments/ai_crm_next/docs/production_canary_approval_package.md`, `experiments/ai_crm_next/docs/production_canary_change_request_template.md`, `experiments/ai_crm_next/docs/production_canary_observability_plan.md`, `experiments/ai_crm_next/docs/production_canary_rollback_runbook.md`, `experiments/ai_crm_next/tools/check_production_canary_approval_package.py`.
...
- files likely involved: `experiments/ai_crm_next/docs/batch_1_media_readonly_human_signoff_submission.md`, `experiments/ai_crm_next/docs/batch_1_media_readonly_production_canary_signoff_packet.md`, `experiments/ai_crm_next/docs/batch_1_media_readonly_production_execution_checklist.md`, `experiments/ai_crm_next/tools/check_batch_1_media_production_signoff_readiness.py`, `experiments/ai_crm_next/docs/production_canary_approval_package.md`.
...
- files likely involved: `experiments/ai_crm_next/docs/batch_1_media_readonly_human_signoff_submission.md`, `experiments/ai_crm_next/docs/batch_1_media_readonly_production_canary_signoff_packet.md`, `experiments/ai_crm_next/docs/batch_1_media_readonly_production_execution_checklist.md`.
...
- files likely involved: `experiments/ai_crm_next/docs/fast_readonly_replacement_execution_plan.md`, `experiments/ai_crm_next/docs/fast_readonly_human_test_tasks.md`, selected batch smoke/parity tools.
...
- suggested validation command: run the selected batch smoke/parity commands listed in `experiments/ai_crm_next/docs/fast_readonly_replacement_execution_plan.md`, then complete the matching section in `experiments/ai_crm_next/docs/fast_readonly_human_test_tasks.md`.
...
- files likely involved: `experiments/ai_crm_next/tools/capture_frontend_screenshots.py`, `experiments/ai_crm_next/docs/frontend_route_manifest.md`, `experiments/ai_crm_next/docs/frontend_screenshot_baseline.md`, `experiments/ai_crm_next/docs/production_replacement_route.md`, future `scripts/`.
