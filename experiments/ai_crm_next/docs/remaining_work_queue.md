...
- files likely involved: `docs/archive/experiments_ai_crm_next/docs/batch_1_media_readonly_canary_execution_report.md`, `docs/archive/experiments_ai_crm_next/docs/batch_1_media_readonly_canary_signoff.md`, `docs/archive/experiments_ai_crm_next/docs/batch_1_media_readonly_canary_runbook.md`, `experiments/ai_crm_next/tools/media_library_gray_smoke.py`, `experiments/ai_crm_next/tools/check_batch_1_media_canary_readiness.py`.
...
- files likely involved: `docs/archive/experiments_ai_crm_next/docs/product_management_gray_release_plan.md`, `experiments/ai_crm_next/docs/product_management_route_cutover_manifest.md`, `experiments/ai_crm_next/tools/product_management_gray_smoke.py`, future deployment smoke scripts.
...
- files likely involved: `docs/archive/experiments_ai_crm_next/docs/batch_2_product_readonly_canary_execution_report.md`, `docs/archive/experiments_ai_crm_next/docs/batch_2_product_readonly_canary_signoff.md`, `docs/archive/experiments_ai_crm_next/docs/batch_2_product_readonly_canary_plan.md`, `docs/archive/experiments_ai_crm_next/docs/batch_2_product_readonly_canary_runbook.md`, `experiments/ai_crm_next/tools/product_management_gray_smoke.py`, `experiments/ai_crm_next/tools/check_batch_2_product_canary_readiness.py`.
...
- files likely involved: `docs/archive/experiments_ai_crm_next/docs/user_ops_readonly_gray_release_plan.md`, `experiments/ai_crm_next/docs/user_ops_readonly_route_cutover_manifest.md`, `experiments/ai_crm_next/docs/user_ops_readonly_sample_and_drift_checklist.md`, `docs/archive/experiments_ai_crm_next/docs/batch_4_user_ops_readonly_canary_plan.md`, `experiments/ai_crm_next/tools/user_ops_readonly_gray_smoke.py`, `experiments/ai_crm_next/tools/check_batch_4_user_ops_canary_readiness.py`.
...
- files likely involved: `docs/archive/experiments_ai_crm_next/docs/batch_4_user_ops_readonly_canary_execution_report.md`, `docs/archive/experiments_ai_crm_next/docs/batch_4_user_ops_readonly_canary_signoff.md`, `docs/archive/experiments_ai_crm_next/docs/batch_4_user_ops_readonly_canary_plan.md`, `docs/archive/experiments_ai_crm_next/docs/batch_4_user_ops_readonly_canary_runbook.md`, `experiments/ai_crm_next/tools/user_ops_readonly_gray_smoke.py`, `experiments/ai_crm_next/tools/readonly_http_dual_run.py`, `experiments/ai_crm_next/tools/check_batch_4_user_ops_canary_readiness.py`.
...
- files likely involved: `docs/archive/experiments_ai_crm_next/docs/batch_5_questionnaire_readonly_canary_execution_report.md`, `docs/archive/experiments_ai_crm_next/docs/batch_5_questionnaire_readonly_canary_signoff.md`, `docs/archive/experiments_ai_crm_next/docs/batch_5_questionnaire_readonly_canary_plan.md`, `docs/archive/experiments_ai_crm_next/docs/batch_5_questionnaire_readonly_canary_runbook.md`, `experiments/ai_crm_next/tools/questionnaire_readonly_gray_smoke.py`, `experiments/ai_crm_next/tools/check_batch_5_questionnaire_canary_readiness.py`.
