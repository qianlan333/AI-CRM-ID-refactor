...
| screenshot baseline | PASS | `docs/frontend_screenshot_baseline.md`, `artifacts/frontend_screenshots/route_status.json` |
| Batch 1 rehearsal | PASS / GO | `docs/gray_rehearsal_batch_1_media_readonly.md` |
| staging/simulated canary | PASS / GO | `docs/batch_1_media_readonly_canary_execution_report.md` |
...
| human signoff packet | prepared, pending | `docs/batch_1_media_readonly_production_canary_signoff_packet.md` |
| production execution checklist | prepared, manual only | `docs/batch_1_media_readonly_production_execution_checklist.md` |
...
4. Execute `docs/batch_1_media_readonly_production_execution_checklist.md`.
