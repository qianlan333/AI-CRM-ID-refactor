...
from aicrm_next.media_library.parity_spec import DEFAULT_SAFE_ENDPOINTS, ENDPOINT_SPECS, compare_endpoint_payloads, compare_status_code  # noqa: E402
...
def run_compare(args: argparse.Namespace) -> dict[str, Any]:
    ...
    return {
        ...
        "side_effect_safety": {"note": "Default comparison uses read-only media endpoints. Upload/import APIs remain fixture/fake only."},
        "results": results,
    }
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Compare old Flask and AI-CRM Next media library API parity.")
