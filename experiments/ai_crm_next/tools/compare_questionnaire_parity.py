...
from aicrm_next.questionnaire.parity_spec import (  # noqa: E402
...
def run_compare(args: argparse.Namespace) -> dict[str, Any]:
    ...
    return {
        ...
        "side_effect_safety": {
            "note": "Default comparison uses fixture-safe submit only. Do not point HTTP mode at old production submit endpoints.",
        },
        "results": results,
    }
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Compare old Flask and AI-CRM Next questionnaire API parity.")
    parser.add_argument("--old-base-url", default="", help="Old Flask AI-CRM base URL. Use with caution; submit must be fixture-safe.")
    parser.add_argument("--next-base-url", default="", help="AI-CRM Next base URL.")
    parser.add_argument("--old-fixture-dir", default="", help="Directory containing old questionnaire JSON response fixtures.")
