...
@router.api_route("/api/admin/automation-conversion/tasks/{task_id:int}/copy", methods=["POST", "OPTIONS"])
@router.api_route("/api/admin/automation-conversion/tasks/{task_id:int}/activate", methods=["POST", "OPTIONS"])
@router.api_route("/api/admin/automation-conversion/tasks/{task_id:int}/pause", methods=["POST", "OPTIONS"])
@router.api_route("/api/admin/automation-conversion/tasks/{task_id:int}", methods=["DELETE", "OPTIONS"])
@router.api_route("/api/admin/automation-conversion/tasks/{task_id:int}/preview-audience", methods=["POST", "OPTIONS"])
@router.api_route("/api/admin/automation-conversion/tasks/run-due", methods=["POST", "OPTIONS"])
@router.api_route("/api/admin/automation-conversion/workflows/{workflow_id:int}", methods=["GET", "PUT", "DELETE", "OPTIONS", "HEAD"])
@router.api_route("/api/admin/automation-conversion/workflows/{workflow_id:int}/summary", methods=["GET", "OPTIONS", "HEAD"])
@router.api_route("/api/admin/automation-conversion/workflows/{workflow_id:int}/activate", methods=["POST", "OPTIONS"])
@router.api_route("/api/admin/automation-conversion/workflows/{workflow_id:int}/pause", methods=["POST", "OPTIONS"])
@router.api_route("/api/admin/automation-conversion/workflows/registry", methods=["GET", "OPTIONS", "HEAD"])
@router.api_route("/api/admin/automation-conversion/agents/{agent_code}", methods=["GET", "DELETE", "OPTIONS", "HEAD"])
@router.api_route("/api/admin/automation-conversion/agents/{agent_code}/draft", methods=["POST", "OPTIONS"])
@router.api_route("/api/admin/automation-conversion/agents/{agent_code}/publish", methods=["POST", "OPTIONS"])
@router.api_route("/api/admin/automation-conversion/agents/options", methods=["GET", "OPTIONS", "HEAD"])
...
@router.api_route("/api/admin/image-library/upload", methods=["POST", "OPTIONS"])
async def legacy_image_library_upload_route(request: Request) -> Response:
    return await forward_to_legacy_flask(request)
