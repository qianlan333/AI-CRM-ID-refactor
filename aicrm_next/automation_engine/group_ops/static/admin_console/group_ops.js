(function (window, document) {
  ...
  function renderCreatePanel() {
    ...
    return `
      <section class="group-ops__create-panel">
  ...
  function renderList(total, queueCount) {
    ...
    renderShell(`
      ...
      <section class="group-ops__card group-ops__list-card">
        <div class="group-ops__list-head">
          <div>
            <h2 class="group-ops__section-title">群运营计划列表</h2>
            <p class="group-ops__section-copy">管理群运营计划、绑定群和计划状态。</p>
          </div>
          <div class="group-ops__list-actions">
