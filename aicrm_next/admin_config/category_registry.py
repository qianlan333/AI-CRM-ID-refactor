...
CONFIG_CATEGORIES: tuple[ConfigCategory, ...] = (
    ...
    ConfigCategory(
        ...
        fields=(
            ...
            field("AICRM_WECOM_PROVIDER_TARGET_POLICY", block_title="企微执行", readonly=True),
            field("AICRM_WECOM_DEFAULT_SENDER_USERID", block_title="企微执行", readonly=True),
            field("AICRM_EXTERNAL_EFFECT_ALLOWED_OWNER_USERIDS", block_title="企微执行", readonly=True),
            field("AICRM_EXTERNAL_EFFECT_ALLOWED_TARGET_EXTERNAL_USERIDS", block_title="企微执行", readonly=True),
            field("AICRM_EXTERNAL_EFFECT_ALLOWED_GROUP_OPS_WEBHOOK_KEYS", block_title="企微执行", readonly=True),
            field("AICRM_EXTERNAL_EFFECT_ALLOWED_GROUP_CHAT_IDS", block_title="企微执行", readonly=True),
            field("AICRM_WECOM_CANARY_ALLOWED_MEDIA_TARGETS", block_title="企微执行", readonly=True),
