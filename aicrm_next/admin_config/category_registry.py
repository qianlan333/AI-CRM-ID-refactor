...
CONFIG_CATEGORIES: tuple[ConfigCategory, ...] = (
    ...
    ConfigCategory(
        ...
        fields=(
            ...
            field("LAOHUANG_CHAT_ENABLED", block_title="老黄 AI"),
            field("LAOHUANG_CHAT_WEBHOOK_URL", block_title="老黄 AI"),
            field("LAOHUANG_CHAT_WEBHOOK_TOKEN", block_title="老黄 AI"),
            field("LAOHUANG_CHAT_TIMEOUT_SECONDS", block_title="老黄 AI"),
            field("LAOHUANG_CHAT_SEND_CHANNEL", block_title="老黄 AI"),
    ...
    ConfigCategory(
        ...
        fields=(
            ...
            field("AICRM_QUESTIONNAIRE_EXTERNAL_PUSH_MODE", block_title="统一队列"),
            field("AICRM_EXTERNAL_EFFECT_WEBHOOK_EXECUTE", block_title="统一队列"),
