import { executionModeForStatus, guardrailsForScenario, validateDropIntent as validateContractDropIntent } from "./interaction_contract.js";
...
export function explainBlockedDrop(result) {
    if (result.allowed)
        return "Allowed preview only; no production write or external call.";
