...
import { createDraftState } from "./draft_state.js";
...
export function applyReadonlyReorderPreview(state, fromIndex, toIndex) {
...
export function serializeDraftPreviewForDisplay(state) {
    return {
        id: state.id,
