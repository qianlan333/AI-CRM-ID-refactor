...
PUSH_CAPABILITIES: tuple[PushCapability, ...] = (
    ...
    PushCapability(
        key="group_broadcast",
        label="群群发",
        description="群群发队列状态展示，真实执行由群发队列和后续 adapter 接入控制。",
        ...
        readonly_reason="当前仅展示队列状态，真实执行由群发队列/后续 adapter 接入控制",
    ),
    PushCapability(
        key="customer_webhook",
        label="客户自动化 Webhook",
        description="旧客户自动化 webhook 重试链路的迁移追溯能力。",
        ...
        readonly_reason="旧链路迁移中，只读追溯",
    ),
    PushCapability(
        key="tags",
        label="企微标签",
        description="企微客户标签标记与取消标记任务状态。",
        section="tags",
        section_label="企微标签",
    ...
    PushCapability(
        key="payment_query",
        label="支付查询",
        description="微信支付和支付宝订单/退款查询任务状态。",
        section="payment",
        section_label="支付查询",
        owner_module="commerce",
        owner_label="交易",
        effect_types=(PAYMENT_WECHAT_ORDER_QUERY, PAYMENT_WECHAT_REFUND_QUERY, PAYMENT_ALIPAY_ORDER_QUERY, PAYMENT_ALIPAY_REFUND_QUERY),
    ...
    PushCapability(
        key="integrations",
        label="集成推送",
        description="Feishu、OpenClaw、素材存储和企微素材上传等集成任务状态。",
        section="integrations",
        section_label="集成推送",
        owner_module="integrations",
        owner_label="集成",
        effect_types=(FEISHU_WEBHOOK_NOTIFY, OPENCLAW_CONTEXT_PUSH, MEDIA_STORAGE_UPLOAD, WECOM_MEDIA_UPLOAD),
        ...
        readonly_reason="当前展示任务与状态，凭据和真实执行开关属于高级配置",
    ),
)
