...
def run_scheduled_external_effects(
    *,
    ...
    if dry_run:
        result = worker.preview_due(batch_size=batch_size, effect_types=None, test_only=False)
        result.update(
            {
