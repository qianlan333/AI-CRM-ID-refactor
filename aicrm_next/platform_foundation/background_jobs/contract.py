...
def webhook_route_contracts() -> tuple[WebhookRouteContract, ...]:
    ...
    return (
        ...
        W("/api/customers/automation/webhook-deliveries/{delivery_id:int}/retry", ("POST",), "api_plan_customer_automation_webhook_delivery_retry", "none", "command", "retry command creates queued external effect job"),
        W("/api/customers/automation/webhook-deliveries/retry-due", ("OPTIONS",), "api_customer_automation_webhook_delivery_retry_due_options", "none", "read_model", "preflight route only"),
