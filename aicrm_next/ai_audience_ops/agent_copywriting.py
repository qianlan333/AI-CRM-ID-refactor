...
def build_variables(*, package: dict[str, Any], member_event: dict[str, Any], context: dict[str, Any] | None = None) -> dict[str, Any]:
    ...
    member = {
        ...
        "external_userid": _text(member_event.get("external_userid") or member_event.get("identity_value")),
    ...
    return repository.create_agent_run(
        {
            ...
            "batch_id": "",
            "userid": "",
            "external_contact_id": _text(member_event.get("external_userid") or member_event.get("identity_value")),
