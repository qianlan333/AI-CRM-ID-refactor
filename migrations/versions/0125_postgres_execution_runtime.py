...
Revision ID: 0125_postgres_execution_runtime
Revises: 0124_execution_runtime_correctness
"""
...
revision = "0125_postgres_execution_runtime"
down_revision = "0124_execution_runtime_correctness"
branch_labels = None
depends_on = None
...
def _create_control_plane() -> None:
    ...
    op.execute(
        ...
        INSERT INTO queue_policy_snapshot (
            ...
            'queue-v1',
            '{"heartbeat_seconds":10,"lease_ttl_seconds":30,"fallback_drain_seconds":30,"outbound_webhook_default":"blocked","lane_capacities":{"internal_general":4,"internal_financial":1,"webhook_inbox":4,"wecom_interactive":4,"wecom_bulk":1,"wecom_media":2,"outbound_webhook":4}}'::jsonb,
            'migration',
